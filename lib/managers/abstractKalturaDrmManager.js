...
class KalturaDrmManager extends kalturaBase.KalturaBase
{
    ...
    license(request, response)
    {
        ...
        //TODO: Change all "errorResponse" to something else since this doesn't work with express
        ...
        const providerData = new kalturaProviderData.KalturaProviderData(this._drmType, customData.account_id, customData.ca_system);
