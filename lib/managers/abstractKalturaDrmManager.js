...
class KalturaDrmManager extends kalturaBase.KalturaBase
{
    ...
    start(app)
    {
        app.post('/cenc/encryption', (...args) => this.encryption(...args));
                                            ///system/ovp/edash/p/101/sp/198255100/entryId/2134/flavorId/0_g6d82oug/forceproxy/true/name/a.mp4
        const outsideEncryptionUrlFormat = '/system/ovp/edash/p/:partnerId/sp/:sp/.*entryId/:entryId/.*flavorId/:flavorId/.*';
