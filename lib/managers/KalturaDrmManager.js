...
class KalturaDrmManager extends kalturaBase.KalturaBase
{
    ...
    encryption(request, response)
    {
        ...
        const validateRequest = function (providerData)
        {
    ...
    createEncryptionData(providerData, postParams)
    {
        ...
        function encryptionDoesntExist(err)
        {
            ...
            return [This.createNewEncryptionData(providerData, postParams, providerData.seed, sharedKey, This._swap)];
        }
    ...
    createNewEncryptionData(providerData,postParams, seed, sharedKey, swap)
    {
        ...
        if (swap)
        {
            keyIdUnbaseStr = keyIdUnbaseStr[3] + keyIdUnbaseStr[2] + keyIdUnbaseStr[1] + keyIdUnbaseStr[0] +
                keyIdUnbaseStr[5] + keyIdUnbaseStr[4] + keyIdUnbaseStr[7] + keyIdUnbaseStr[6] + keyIdUnbaseStr.substr(8);
    ...
    license(request, response)
    {
        ...
        const providerDataPromise = providerData.getProviderData();

        const validateRequest = function (innerProviderData)
        {
