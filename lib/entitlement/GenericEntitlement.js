...
var GenericEntitlement = function(server, customData , can_skip)
{
    ...
    this.systemType = customData.ca_system; // for future development (moving type to generic responsibility - aka factory)
};
...
GenericEntitlement.prototype.getEntitlement = function()
{
    ...
    /*
    // future: add factory method as:
    switch (this.systemType) {
        case "OVP":
            //create new OVPEntitlement object
            break;
        case "OTT":
            //create new OTTEntitlement object
            break;
        default:
            break;
    }
