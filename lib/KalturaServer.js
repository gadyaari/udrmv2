...
KalturaChildProcess.prototype.configureExpressApp = function(app)
{
	...
	app.post('/cenc/widevine/license', handleCencWidevineLicenseRequest);
};

var handleCencEncryptionRequest = function(request, response)
{
	service = new kalturaWidevineManager.KalturaWidevineManager();
	service.encryption(request, response);
};

var handleCencWidevineLicenseRequest = function(request, response)
{
	service = new kalturaWidevineManager.KalturaWidevineManager();
	service.license(request, response);
};
