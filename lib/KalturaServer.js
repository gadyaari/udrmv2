...
KalturaChildProcess.prototype.configureExpressApp = function(app)
{
	...
	let managerFiles = fs.readdirSync('/opt/kaltura/apps/concepcion/lib//managers');//.filter(function(filename,index,arr){return (filename.substr(0,7) == 'Kaltura' && filename.substr(-3) == '.js')});
